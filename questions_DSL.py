def questions(task, db_manager, i):
    ...
    #first_five_props = get properties on first five-
    j = 0
    while j < 5:
        ...
        # check if object is scaled 
            shape_1 = dict1.get('shape')
            shape_2 = dict2.get('shape')
    ...
    #check if object is moved 
            x_coordinate_1 = dict1.get("bbox_x")
            x_coordinate_2 = dict2.get("bbox_x")
            ...
            y_coordinate_1 = dict1.get("bbox_y")
            y_coordinate_2 = dict2.get("bbox_y")
            ...
            color_1 =  dict1.get('color')
            color_2 = dict2.get('color')
            if color_1 == color_2:
                changes[color] = "No"
            else:
                changes[color] = "Yes"
