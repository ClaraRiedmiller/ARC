...
class Transformer:
    ...
    def pixel_out_with_uncovered_neighbors(self, object: Object) -> (Object, Object):
        outside_pixels = set()
    ...
    def pixel_out_with_uncovered_neighbors_with_diagonal(self, object: Object) -> (Object, Object):
        outside_pixels = set()
        uncovered_neighbors = set()
    ...
    def pixel_out_with_uncovered_neighbors_only_diagonal_neighborhood(self, object: Object) -> (Object, Object):
        outside_pixels = set()
        uncovered_neighbors = set()
    ...
    def grid_duplicate_down(self, object: Object) -> Object: #add one more gridline by duplication the bottom line
        ...
        for pixel in object:
            outcome.add(pixel)
        sorted_object = filter(lambda pixel: pixel[1] == self.grid_height - 1, object)
    ...
    def grid_duplicate_up(self, object: Object) -> Object: #add one more gridline by duplication the top line
        ...
        for pixel in object:      
            newpixel = (pixel[0], pixel[1] + 1, pixel[2])
            outcome.add(newpixel)
        sorted_object = filter(lambda pixel: pixel[1] == 0, object)
        for pixel in filtered_pixels:
    ...
    def grid_duplicate_right(self, object: Object) -> Object: #add one more gridline by duplication the right line
        ...
        for pixel in object:
            outcome.add(pixel)
        sorted_object = filter(lambda pixel: pixel[0] == self.grid_width - 1, object)
        for pixel in filtered_pixels:
    ...
    def grid_duplicate_left(self, object: Object) -> Object: ##add one more gridline by duplication the left line
        ...
        for pixel in object:
            newpixel = (pixel[0] +1, pixel[1], pixel[2])
            outcome.add(newpixel)
        sorted_object = filter(lambda pixel: pixel[0] == 0, object)
        for pixel in filtered_pixels:
    ...
    def grid_duplicate_left_and_right (self, object: Object) -> Object: #duplication of left and right
        ...
        sorted_object_right = filter(lambda pixel: pixel[0] == self.grid_width - 1, object)
